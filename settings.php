...
try {
	...
	switch ($_GET['edit']) {
		...
		case 'basic':
			/* valid inputs */
			if(!isset($_POST['firstname']) || !isset($_POST['lastname']) || !isset($_POST['birth_month']) || !isset($_POST['birth_day']) || !isset($_POST['birth_year']) || 
			!isset($_POST['nationality']) || !isset($_POST['job'])  || !isset($_POST['jobseeking']) || !isset($_POST['jobseekingcity']) 
			|| !isset($_POST['seniority'])) {
				_error(400);
			}
		...
		case 'education':
			...
			|| !isset($_POST['edustart_month']) || !isset($_POST['edustart_day']) || !isset($_POST['edustart_year'])   ) {
				_error(400);
			}
			$user->settings($_GET['edit'], $_POST);
			return_json( array('success' => true, 'message' => __("Your profile info has been updated")) );
