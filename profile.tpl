                        ...
                        <div class="panel panel-default text-left">
                            ...
                            {* {if !is_empty($profile['user_biography'])}
                                ...
                                <ul class="about-list">
                                        ...
                                        {* {if $profile['user_id'] == $user->_data['user_id'] || $profile['user_privacy_work'] == "public" || ($profile['user_privacy_work'] == "friends" && $profile['we_friends'])} *}
                                            <li>
                                                <div class="about-list-item">
                                                    ...
                                                    {$profile['Firstname']} {__(" ")} <span class="text-link">{$profile['Surname']}</span>
                                                </div>
                                            </li>
                                        {* {/if} *}
                                    {/if}
                                    ...
                                    {if $profile['Posicion']}
                                            ...
                                            <li>
                                                <div class="about-list-item">
                                                   ...
                                                   {$profile['Posicion']} 
                                                    {__("at")}  <span class="text-link">{$profile['']}</span>
                                                </div>
                                            </li>
                                    ...
                                    {if $profile['Jobseeking_City']}
                                       
                                            <li>
                                                <div class="about-list-item">
                                                    
                                                    {__("Buscando trabajo en")} <span class="text-link">{$profile['Jobseeking_City']}</span>
                                                </div>
                                            </li>
                                    ...
                                    {if $profile['Age']}
                                            ...
                                            <li>
                                                <div class="about-list-item">
                                                    <span class="text-link">{$profile['Age']} {__("años")}</span>
                                                </div>
                                            </li>
                                    ...
                                    {if $profile['Seniority']}
                                            ...
                                            <li>
                                                <div class="about-list-item">
                                                {__("Seniority: ")}  <span class="text-link">{$profile['Seniority']}</span>
                                                </div>
                                            </li>
                ...
                <div class="col-xs-6" style="margin-top: 15px;">
                        <div class="panel panel-default text-left">
                            <div class="panel-body">
                                    ...
                                    <div class="about-bio">
                                        {__("Education")}
                                        <button class="btn btn-success btn-sm pull-right" data-toggle="modal" data-url="#create-education">
                                        <i class="fa fa-plus-circle fa-fw"></i><span class="hidden-xs">{__("Add")}</span>
                                        </button>
                                    </div>
                                    ...
                                    {if count($educations) > 0}
                                        <ul class="row">
                                            {foreach $educations as $education}
                                                ...
                                                {include file='__feeds_education.tpl'}
                                        <hr style= "widht:1px;">
                                        ...
                                        <!-- see-more -->
                                        {if count($educations) >= $system['max_results_even']}
