...
{else}
    ...
    <script id="create-education" type="text/template">
        <div class="modal-header">
            <button type="button" class="close" data-dismiss="modal" aria-hidden="true">×</button>
            <h5 class="modal-title">{__("Add Education")}</h5>
        </div>
        <form class="js_ajax-forms" data-url="pages_groups_events/create.php?type=education&do=create">
            <div class="modal-body">
                <div class="form-group">
                    <label for="title">{__("Universidad")}</label>
                     <select class="form-control" name="university" id="university">
                        <option>{__("Select University")}</option>
                        {foreach $universities as $university}
                        <option value="{$university['ID']}">{__($university['University'])}</option>
                        {/foreach}
                    </select>
                </div>
                <div class="form-group">
                    <label for="title">{__("Grado")}</label>
                     <select class="form-control" name="grade" id="grade">
                        <option>{__("Select Grade")}</option>
                        {foreach $grades as $grade}
                        <option value="{$grade['ID_Grade']}">{__($grade['Grade'])}</option>
                        {/foreach}
                    </select>
                </div>
                <div class="form-group">
                    <label for="title">{__("Área de estudio")}</label>
                     <select class="form-control" name="macrosubject" id="macrosubject">
                        <option>{__("Select Area")}</option>
                        {foreach $macrosubjects as $macrosubject}
                        <option value="{$macrosubject['ID']}">{__($macrosubject['MacroSubject'])}</option>
                        {/foreach}
                    </select>
                </div>
                <div class="form-group">
                    <label for="title">{__("País")}</label>
                ...
                <div class="form-group">
                    <label for="description">{__("Promedio Examenes")}</label>
                    <input type='text' class="form-control" name="averagemark" />
                </div>
                <div class="form-group">
                    <label for="idioma">{__("Idioma Carrera")}</label>
                     <select class="form-control" name="idioma" id="idioma">
                        <option>{__("Select Language")}</option>
                        {foreach $idiomas as $idioma}
                        <option value="{$idioma['ID']}">{__($idioma['Language'])}</option>
                        {/foreach}
                    </select>
                </div>
                <div class="form-group">
                    <label for="thesis">{__("Tesis Experimental")}</label>
                ...
                <div class="form-group">
                    <label for="stduration">{__("Duración Standard de la Carrera")}</label>
                                      <select name="stduration" class="form-control">
                                            <option value="none">{__("Select")}</option>
                                            <option value="1">{__("1 año")}</option>
                                            <option value="1.5">{__("1 año y medio")}</option>
                                            <option value="2">{__("2 años")}</option>
                                            <option value="2.5">{__("2 años y medio")}</option>
                                            <option value="3">{__("3 años")}</option>
                                            <option value="4">{__("4 años")}</option>
                                            <option value="5">{__("5 años")}</option>
                                            <option value="6">{__("6 años")}</option>
                                        </select>
                </div>
                <div class="form-group">
                    <label for="completamiento">{__("Porcentaje de Completamiento")}</label>
                     <select class="form-control" name="completamiento" id="completamiento">
                        <option>{__("Select Percentage")}</option>
                        {foreach $completamientos as $completamiento}
                        <option value="{$completamiento['id']}">{__($completamiento['Percentage'])}</option>
                        {/foreach}
                    </select>
                </div>
