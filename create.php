...
try {
	...
	switch ($_GET['type']) {
		...
		case 'event':
			...
			// education create
			if($_GET['do'] == "create") {
				$education_id = $user->create_education($_POST['university'], $_POST['start_date'], $_POST['end_date'], $_POST['grade'], 
				$_POST['macrosubject'], $_POST['country'], $_POST['averagemark'] , $_POST['idioma'],  $_POST['thesis'] ,  $_POST['stduration'], 
				$_POST['completamiento'] );
				$return['path'] = $system['system_url'].'/';
				// $return['path'] = $system['system_url'].'/'.$this->_data['username'];
