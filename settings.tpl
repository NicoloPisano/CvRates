                        ...
                        <div class="tab-pane active" id="basic">
                            <form class="js_ajax-forms form-horizontal" data-url="users/settings.php?edit=basic">
                                <div class="form-group">
                                    ...
                                    <div class="col-sm-9">
                                        <input class="form-control" name="firstname" value="{$user->_data['Firstname']}">
                                    </div>
                                </div>
                                <div class="form-group">
                                    <label class="col-sm-3 control-label">
                                    ...
                                    <div class="col-sm-9">
                                        <input class="form-control" name="lastname" value="{$user->_data['Surname']}">
                                    </div>
                                </div>
                                {* <div class="form-group">
                                    <label class="col-sm-3 control-label">
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="col-sm-9">
                                        <select name="nationality" class="form-control">
                                            ...
                                            <option {if $user->_data['Nationality'] == $country['ID']}selected{/if} value="{$country['ID']}">{__($country['Name'])}</option>
                                            {/foreach}
                                        </select>
                                    </div>
                                </div>
                                <div class="form-group">
                                    ...
                                    <div class="col-sm-9">
                                        <select name="job" class="form-control">
                                            ...
                                            <option {if $user->_data['ID_Position_Title'] == $position['ID']}selected{/if} value="{$position['ID']}">{__($position['Posicion'])}</option>
                                            {/foreach}
                                        </select>
                                    </div>
                                </div>
                                <div class="form-group">
                                    <label class="col-sm-3 control-label">
                                        {__("Actualmente en busqueda")}
                                    </label>
                                    <div class="col-sm-9">
                                        <select name="jobseeking" class="form-control">
                                            <option value="none">{__("Select")}</option>
                                            <option {if $user->_data['Jobseeking'] == "1"}selected{/if} value="1">{__("Si")}</option>
                                            <option {if $user->_data['Jobseeking'] == "0"}selected{/if} value="0">{__("No")}</option>
                                        </select>
                                    </div>
                                </div>
                                 <div class="form-group">
                                    <label class="col-sm-3 control-label">
                                        {__("Ciudad de busqueda")}
                                    </label>
                                    <div class="col-sm-9">
                                        <input type="text" class="form-control js_geocomplete" name="jobseekingcity" value="{$user->_data['Jobseeking_City']}">
                                    </div>
                                </div>
                                <div class="form-group">
                                    <label class="col-sm-3 control-label" for "seniority">
                                        {__("Seniority")}
                                    </label>
                                    <div class="col-sm-9">
                                        <select name="seniority" class="form-control">
                                            {foreach $seniorities as $seniority}
                                            <option {if $user->_data['SeniorityLevel'] == $seniority['ID']}selected{/if} value="{$seniority['ID']}">{__($seniority['SeniorityLevel'])}</option>
                                            {/foreach}
                                        </select>
                                    </div>
                                </div>
                                ...
                                <div class="form-group">
                                 ...
                                 <div class="form-group">
                                    ...
                                    <div class="col-sm-9">
                                        <div class="row">
                                            <div class="col-xs-4">
                                                <select class="form-control" name="edustart_month">
                                                    <option value="none">{__("Select Month")}</option>
                                                    <option {if $user->_data['user_startdate_parsed']['month'] == '1'}selected{/if} value="1">{__("Jan")}</option>
                                                    <option {if $user->_data['user_startdate_parsed']['month'] == '2'}selected{/if} value="2">{__("Feb")}</option>
                                                    <option {if $user->_data['user_startdate_parsed']['month'] == '3'}selected{/if} value="3">{__("Mar")}</option>
                                                    <option {if $user->_data['user_startdate_parsed']['month'] == '4'}selected{/if} value="4">{__("Apr")}</option>
                                                    <option {if $user->_data['user_startdate_parsed']['month'] == '5'}selected{/if} value="5">{__("May")}</option>
                                                    <option {if $user->_data['user_startdate_parsed']['month'] == '6'}selected{/if} value="6">{__("Jun")}</option>
                                                    <option {if $user->_data['user_startdate_parsed']['month'] == '7'}selected{/if} value="7">{__("Jul")}</option>
                                                    <option {if $user->_data['user_startdate_parsed']['month'] == '8'}selected{/if} value="8">{__("Aug")}</option>
                                                    <option {if $user->_data['user_startdate_parsed']['month'] == '9'}selected{/if} value="9">{__("Sep")}</option>
                                                    <option {if $user->_data['user_startdate_parsed']['month'] == '10'}selected{/if} value="10">{__("Oct")}</option>
                                                    <option {if $user->_data['user_startdate_parsed']['month'] == '11'}selected{/if} value="11">{__("Nov")}</option>
                                                    <option {if $user->_data['user_startdate_parsed']['month'] == '12'}selected{/if} value="12">{__("Dec")}</option>
                                                </select>
                                            </div>
                                            <div class="col-xs-4">
                                                <select class="form-control" name="edustart_day">
                                                    <option value="none">{__("Select Day")}</option>
                                                    {for $i=1 to 31}
                                                    <option {if $user->_data['user_startdate_parsed']['day'] == $i}selected{/if} value="{$i}">{$i}</option>
                                                    {/for}
                                                </select>
                                            </div>
                                            <div class="col-xs-4">
                                                <select class="form-control" name="edustart_year">
                                                    <option value="none">{__("Select Year")}</option>
                                                    {for $i=1905 to 2019}
                                                    <option {if $user->_data['user_startdate_parsed']['year'] == $i}selected{/if} value="{$i}">{$i}</option>
                                                    {/for}
                                                </select>
                                            </div>
                                        </div>
